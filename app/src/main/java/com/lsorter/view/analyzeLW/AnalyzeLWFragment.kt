...
import com.lsorter.databinding.FragmentAnalyzeLwBinding
import com.lsorter.utils.PreferencesUtils
import java.util.concurrent.Executor
import java.util.concurrent.Executors

class AnalyzeLWFragment : Fragment() {
    private val analysisExecutor: Executor = Executors.newFixedThreadPool(4)
    private lateinit var binding: FragmentAnalyzeLwBinding
    private lateinit var viewModel: AnalyzeLWViewModel
    ...
    override fun onCreateView(
        ...
        binding = FragmentAnalyzeLwBinding.inflate(inflater, container, false)
        viewModel = ViewModelProvider(this).get(AnalyzeLWViewModel::class.java)
        binding.analyzeLWViewModel = viewModel
